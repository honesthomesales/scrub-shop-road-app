-- Updated Supabase Database Schema for Scrub Shop Road App
-- Based on actual Google Sheets data structure
...
-- Create tables based on actual Google Sheets structure

-- Trailer History Table (matches actual Google Sheets data)
...
-- Venues Table (extracted from sales data)
CREATE TABLE venues (
  id BIGSERIAL PRIMARY KEY,
